"""Atomic fiscalized posting + audit persistence — Phase 5AF.2.
...
def _build_audit_record(snapshot, entry_id):
    """Map one immutable audit snapshot to exact persisted metadata."""
...
def execute_fiscalized_posting_with_audit(instruction):
    """Persist confirmed accounting truth and fiscal provenance atomically."""
