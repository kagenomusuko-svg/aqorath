...
- **E:** `aqorath/audit_event.py`, `test_p6_audit_event_foundation.py` sólo fundamento de auditoría, no workflow de reversión. **F:** AQR-003: inmutabilidad posted, vínculos, rechazo de doble reversión y pruebas con períodos/submayores.
